namespace Linger.HttpClient.Contracts.Metrics;
...
{
    private static readonly Lazy<HttpClientMetrics> s_instance = new(() => new HttpClientMetrics());

    /// <summary>
    /// 获取单例实例
    /// </summary>
    public static HttpClientMetrics Instance => s_instance.Value;
