...
- **Convenience Service API**: Helper methods for common email scenarios
- **ASP.NET Core Friendly**: Designed for controllers, hosted services, and application startup code
