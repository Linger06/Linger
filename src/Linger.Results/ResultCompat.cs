...
/// </summary>
[Obsolete("ResultCompat class is obsolete and will be removed in future versions. Please use the new Result API.")]
public static class ResultCompat
{
    ...
    [Obsolete("This method is obsolete and will be removed in future versions. Please use the new Result API.")]
