...
public static class ExcelExtensions
{
        ...
        string title = "")
    {
        ...
        return excelService.CollectionToExcel(items, columns, fullFileName, sheetsName, title);
    }
        ...
        string title = "")
    {
        ...
        return excelService.CollectionToMemoryStream(items, columns, sheetsName, title);
    }
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        return excelService.CollectionToExcelAsync(items, columns, fullFileName, sheetsName, title, cancellationToken);
    }
