...
/// </summary>
[Obsolete("ExtensionMethodSetting is deprecated. For JSON-related configurations, use JsonDefaults from Linger.Json namespace instead. This API will be removed in 2.0.")]
public static class ExtensionMethodSetting
{
    ...
    [Obsolete("Use JsonDefaults.CreateResponseOptions() from Linger.Json namespace instead. This API will be removed in 2.0.")]
    ...
    [Obsolete("Use JsonDefaults.CreateRequestOptions() from Linger.Json namespace instead. This API will be removed in 2.0.")]
