...
public static partial class FileHelper
{
    ...
    [Obsolete("Use File.ReadLines(filePath).Count() or a dedicated streaming reader instead. This API will be removed in 2.0.")]
    ...
    /// </summary>
    /// <param name="filePath">Absolute file path.</param>
    [Obsolete("Use filePath.GetFileSize() instead. This API will be removed in 2.0.")]
    ...
    [Obsolete("Use FileHelper.GetDirectories(directoryPath, searchOption: SearchOption.TopDirectoryOnly) instead. This API will be removed in 2.0.")]
    ...
    [Obsolete("Use FileHelper.GetDirectories(directoryPath, searchPattern, isSearchChild ? SearchOption.AllDirectories : SearchOption.TopDirectoryOnly) instead. This API will be removed in 2.0.")]
    ...
    /// <param name="searchPattern">Search pattern such as <c>*.xml</c>.</param>
    /// <param name="isSearchChild">Whether to include nested directories.</param>
    [Obsolete("Use FileHelper.GetFileNames(directoryPath, searchPattern, searchOption: isSearchChild ? SearchOption.AllDirectories : SearchOption.TopDirectoryOnly) instead. This API will be removed in 2.0.")]
    ...
    [Obsolete("Use Directory.CreateDirectory(directoryPath) instead. This API will be removed in 2.0.")]
    ...
    [Obsolete("No direct replacement is planned. Prefer explicit Directory and File operations in the caller. This API will be removed in 2.0.")]
