...
public sealed class RetryHelper(RetryOptions? options = null)
{
    ...
    [Obsolete("Use the overload that accepts Func<CancellationToken, Task<T>> so cancellation reaches the operation. This API will be removed in 2.0.")]
    ...
    /// <exception cref="OutOfRetryCountException">超过重试次数时抛出</exception>
    [Obsolete("Use the overload that accepts Func<CancellationToken, Task> so cancellation reaches the operation. This API will be removed in 2.0.")]
