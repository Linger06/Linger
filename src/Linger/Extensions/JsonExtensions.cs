...
public static class JsonExtensions
{
    ...
    /// </code>
    /// </example>
    [Obsolete("DataContractJsonSerializer compatibility is deprecated. Use ToJsonString(value, jsonSerializerOptions) instead. This API will be removed in 2.0.")]
    ...
    /// </code>
    /// </example>
    [Obsolete("The Encoding parameter does not apply to a string result. Use ToJsonString(value, jsonSerializerOptions) instead. This API will be removed in 2.0.")]
    ...
    /// </code>
    /// </example>
    [Obsolete("Use ToJsonString(value, jsonSerializerOptions) instead. This API will be removed in 2.0.")]
    ...
    /// </code>
    /// </example>
    [Obsolete("DataContractJsonSerializer compatibility is deprecated. Use Deserialize<T>(value, jsonSerializerOptions) instead. This API will be removed in 2.0.")]
    ...
    /// </code>
    /// </example>
    [Obsolete("The Encoding parameter does not apply to a .NET string. Use Deserialize<T>(value, jsonSerializerOptions) instead. This API will be removed in 2.0.")]
    ...
    /// </code>
    /// </example>
    [Obsolete("Use JsonDocument, JsonElement, or JsonNode instead. This API will be removed in 2.0.")]
    ...
    /// </code>
    /// </example>
    [Obsolete("Use JsonDocument, JsonElement, or JsonNode instead. This type will be removed in 2.0.")]
