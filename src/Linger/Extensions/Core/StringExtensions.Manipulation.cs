...
public static partial class StringExtensions
{
    ...
    /// </code>
    /// </example>
    [Obsolete("For single-character removal prefer RemoveLastChar(char). For multi-character exact suffix removal use RemoveSuffixOnce(string, StringComparison). The multi-character overload trims by character set (legacy). This API will be removed in 2.0.", false)]
